package org.unisk.uri

import org.apache.spark.sql.{Row, SaveMode, SparkSession}
import org.unisk.uri.udf.{Idfa, UriPrefix}
...
object SparkUriQuery {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def uriFilter(iter: Iterator[Row]): Iterator[(String, String, String, String, String, String,
      String, String, String, String, String, String, String)] = {
      val uri_map = uri_bc.value
      var list = ListBuffer[(String, String, String, String, String, String, String,
              ...
              iter.foreach(arr => {
                ...
                if (isAppend) {
                  list append ((key, row.getString(0), row.getString(1), row.getString(2), row.getString(3),
                    uri, row.getString(6), row.getString(7), row.getString(8), row.getString(9), row.getString(10),
                    arr(1), arr(0)))
                }
              })
            })
    ...
    var r_df = http_df.mapPartitions(uriFilter).
      toDF("uri_key", "msisdn", "imsi", "imei", "idfa", "uri", "ua", "refer", "starttime", "lac", "ci" ,"business", "keyword")
